...
object digitalCircuit extends digitalCircuit

class digitalCircuit extends ScalaModule with ScalafmtModule with PublishModule { m =>
  ...
  def publishVersion = v.digitalCircuit
  ...
  def pomSettings = PomSettings(
    ...
    versionControl = VersionControl.github("wissy", "digitalCircuit"),
    developers = Seq(
      Developer("wissy", "Cheng Guanghui", "XXX")
    )
  )
}
